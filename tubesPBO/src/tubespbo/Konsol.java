...
public class Konsol {
    ...
    public Pelanggan getPelanggan(int x){
        return daftarPelanggan.get(x);
    }
    
    public Pengemudi getPengemudi(int x){
        return daftarPengemudi.get(x);
    }
    
    public void deletePelanggan(int x){
        daftarPelanggan.remove(x);
    }
    
    public void deletePengemudi(int x){
        daftarPengemudi.remove(x);
    }
    
    public Pelanggan loginPelanggan(String username, String password){
        for(int i=0; i<daftarPelanggan.size();i++){
            if((daftarPelanggan.get(i).getUsername().equalsIgnoreCase(username))&&(daftarPelanggan.get(i).getPassword().equals(password))){
    ...
    public Pengemudi loginPengemudi(String username, String password){
        for(int i=0; i<daftarPengemudi.size();i++){
            if((daftarPengemudi.get(i).getUsername().equalsIgnoreCase(username))&&(daftarPengemudi.get(i).getPassword().equals(password))){
